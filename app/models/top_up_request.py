...
class TopUpRequest(Base):
    ...
    matched_provider_tx_id: Mapped[str | None] = mapped_column(String(255), nullable=True)
    last_auto_verify_attempt_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    last_auto_verify_note: Mapped[str | None] = mapped_column(Text, nullable=True)
